      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <ul className="mt-8 space-y-2">
          {faqItems.map((item, index) => (
            <FadeIn key={index} as="li" delay={100 + index * 70}>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] shadow-sm transition-shadow duration-200 hover:shadow-md">
                <button
                  type="button"
                ...
                >
                  ...
                  <span
                    className={`shrink-0 text-[var(--primary)] transition-transform duration-300 ${openIndex === index ? "rotate-180" : ""}`}
                    aria-hidden
                  >
                ...
                {/* Animação suave com grid-template-rows */}
                <div
