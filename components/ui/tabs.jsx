...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-[var(--muted)] p-1.5 text-[var(--muted-foreground)]",
      className
    )}
    {...props}
  />
