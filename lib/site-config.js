...
export const contactSection = {
  ...
  intro: [
    ...
    "Se a sua busca for psicoterapia individual, recomendamos realizar o agendamento diretamente pela plataforma de atendimento.",
  ],
  whatsappCard: {
  ...
  platformCard: {
    ...
    subtitle:
      "Se você busca atendimento psicológico individual, o agendamento pode ser realizado diretamente pela nossa plataforma.",
    detail: "Isso permite visualizar horários disponíveis e escolher o profissional.",
    buttonLabel: "Acessar plataforma de agendamento",
    buttonLabelShort: "Acessar plataforma",
  },
  emailCard: {
...
export function getWhatsAppHref() {
  ...
  return num ? `https://wa.me/55${21971486007}` : "#";
}
...
export const faqItems = [
  {
    ...
    answer:
      "O agendamento pode ser realizado diretamente pelo site ou por meio de contato via WhatsApp.\n\nApós o primeiro contato, são apresentadas as opções de horários disponíveis. A primeira sessão é um momento de acolhimento, em que a pessoa pode apresentar suas questões, conhecer a forma de trabalho do profissional e compreender como poderá ser conduzido o acompanhamento.",
  },
  {
